...
Icons = {
    ...
    Artemis = { Name = "Jowday-DamageMeter\\DpsArtemisIcon", Scale = 0.2 },
    Athena = { Name = "Jowday-DamageMeter\\DpsAthenaIcon", Scale = 0.2 },
    Demeter = { Name = "Items\\Loot\\Boon\\DemeterIconSpin\\DemeterIconSpin0015", Scale = 0.2 },
    Dionysus = { Name = "Jowday-DamageMeter\\DpsDionysusIcon", Scale = 0.2 },
