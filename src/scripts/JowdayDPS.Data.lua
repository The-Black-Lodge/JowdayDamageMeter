...
Icons = {
    ...
    Artemis = { Name = _PLUGIN.guid.."\\DpsArtemisIcon", Scale = 0.1 },
    Athena = { Name = _PLUGIN.guid.."\\DpsAthenaIcon", Scale = 0.2 },
    Demeter = { Name = "Items\\Loot\\Boon\\DemeterIconSpin\\DemeterIconSpin0015", Scale = 0.2 },
    Dionysus = { Name = _PLUGIN.guid.."\\DpsDionysusIcon", Scale = 0.1 },
    Hades = { Name = _PLUGIN.guid.."\\DpsHadesIcon", Scale = 0.1 },
