JowdayDPS.NameLookup = {
    ...
    SpearWeaponSpin = "Spin Attack",
    SpearWeaponSpin2 = "Spin Attack",
...
JowdayDPS.SourceLookup = {
    ...
    Artemis = { "Artemis' Aid", "Support Fire", "Exit Wounds", "ArtemisRangedTrait", "ShieldLoadAmmo_ArtemisRangedTrait", "Hunter Dash-Strike" },
